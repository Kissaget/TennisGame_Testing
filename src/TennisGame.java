...
// "player2 wins"
			...
			if (player1Points >= 3 && player1Points == player2Points) //Previously only returned deuce at 4 points
				return "deuce";
			...
			return  player1Score + " - " + player2Score ; //Previously format was player2Score - player1Score
	}
}